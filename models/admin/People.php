...
class People
{
    ...
    public function dashboard_list()
    {
        ...
        //Query
        $query = 'SELECT people_id, name, email, gender, date_of_birth, com_id, position, account_status, people.created_at FROM ' . $this->table . ' JOIN company ON com_id = company_id ORDER BY people_id DESC LIMIT 0,10';
